...
import com.zxl.zhaodemo.utils.DensityUtil;
...
public class ZxlSideBar extends View{
    private Paint paint;
    ...
    public ZxlSideBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(){
        ...
        paint.setColor(Color.parseColor("#6796FE"));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:{
                if(header == null){
                    header = (TextView) ((View)getParent()).findViewById(R.id.sidebar_tv);
                }
